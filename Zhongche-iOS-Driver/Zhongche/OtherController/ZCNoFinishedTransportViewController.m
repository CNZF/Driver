//
//  ZCNoFinishedTransportViewController.m
//  Zhongche
//
...
@interface ZCNoFinishedTransportViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ZCNoFinishedTransportViewController
...
- (void)getData {
    ...
    [vm selectCapacityWith:0 callback:^(NSArray *recordList) {
