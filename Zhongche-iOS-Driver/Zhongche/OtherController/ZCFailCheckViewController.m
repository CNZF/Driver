...
- (void)bindView{
    ...
    self.ivCartoon.frame = CGRectMake(SCREEN_W/2 -75, 60, 150, 145);
    [self.view addSubview:self.ivCartoon];


    self.lbText.frame = CGRectMake(self.ivCartoon.left - 10, self.ivCartoon.bottom + 20, 200, 130);
    ...
    self.btnPerfect.frame = CGRectMake(20, SCREEN_H - 200, SCREEN_W - 40, 50);
...
- (UIImageView *)ivCartoon {
    if (!_ivCartoon) {
        ...
        imageView.image = [UIImage imageNamed:@"zhuce_pic_4"];
