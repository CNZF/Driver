...
- (void)bindView{
    ...
    self.tvList.frame = CGRectMake(0, 0, SCREEN_W, SCREEN_H - kiPhoneFooterHeight- kNavBarHeaderHeight- 64);
    ...
    self.viBottom.frame = CGRectMake(0, SCREEN_H - 64 - kiPhoneFooterHeight - kNavBarHeaderHeight, SCREEN_W, 64);
    [self.view addSubview:self.viBottom];

    self.btnNext.frame = CGRectMake(20, 10, SCREEN_W - 40, 44);
...
- (UIButton *)btnNext {
    if (!_btnNext) {
        ...
        [button.layer setCornerRadius:20.0];//设置矩形四个圆角半径
