...
//
    ...
    self.btnAddCar.frame = CGRectMake(20,SCREEN_H - 160 ,SCREEN_W-40 , 44);
    [self.view addSubview:self.btnAddCar];


    self.tvList.frame = CGRectMake(0, 0, SCREEN_W, self.btnAddCar.top - 80);
     [self.view addSubview:self.tvList];
...
//    [self.view addSubview:self.btnManager];
    ...
    self.viFoot.frame = CGRectMake(0, self.tvList.bottom, SCREEN_W, 60);
