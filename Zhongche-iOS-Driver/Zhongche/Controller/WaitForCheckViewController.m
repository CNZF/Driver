...
-(void)bindView {
    ...
    self.ivWaite.frame = CGRectMake(SCREEN_W/2 - 70 *SCREEN_W_COEFFICIENT, 50, 140 *SCREEN_W_COEFFICIENT, 140 * SCREEN_W_COEFFICIENT);
...
- (UIImageView *)ivWaite {
    if (!_ivWaite) {
        ...
        imageView.image = [UIImage imageNamed:@"wait"];
