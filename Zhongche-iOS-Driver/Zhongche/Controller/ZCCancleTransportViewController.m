//
//  ZCCancleTransportViewController.m
//  Zhongche
//
...
@interface ZCCancleTransportViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ZCCancleTransportViewController
...
- (void)getData {
    ...
    [vm selectCapacityWith:2 callback:^(NSArray *recordList) {
