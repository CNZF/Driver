//
//  ZCNoFinishedOrderViewController.m
//  Zhongche
//
...
#import "ZCNoFinishedOrderViewController.h"
...
@interface ZCNoFinishedOrderViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ZCNoFinishedOrderViewController
...
//         cell.lbState.text = @"待确认";
//        if (model.status == 3) {
//            cell.lbState.text = @"待装载";
//        }
//        if (model.status == 4) {
//            cell.lbState.text = @"在途";
//        }
//        if (model.status == 5) {
//            cell.lbState.text = @"已抵达";
//        }
//
//
//        switch (model.type) {
