//
//  ZCFinishedOrderViewController.m
//  Zhongche
//
...
@interface ZCFinishedOrderViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ZCFinishedOrderViewController
...
- (void)getData {
    ...
    [vm selectOrderWithType:1 WithDriverid:[info.driverId intValue] callback:^(NSMutableArray *arrInfo) {
