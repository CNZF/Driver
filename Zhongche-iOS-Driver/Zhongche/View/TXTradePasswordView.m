...
- (id)initWithFrame:(CGRect)frame WithTitle :(NSString *)title
{
    ...
    if (self)
    {
        ...
        _lable_title.frame = CGRectMake(0, 20, SCREEN_WIDTH - 40, 20);
        ...
        ///  假的输入框
        _view_box = [[UIView alloc]initWithFrame:CGRectMake(35, 60, boxWidth, boxWidth)];
        ...
        _view_box2 = [[UIView alloc]initWithFrame:CGRectMake(35+boxWidth*1, _view_box.frame.origin.y, boxWidth, boxWidth)];
        ...
        _view_box3 = [[UIView alloc]initWithFrame:CGRectMake(35+boxWidth*2, _view_box.frame.origin.y, boxWidth, boxWidth)];
        ...
        _view_box4 = [[UIView alloc]initWithFrame:CGRectMake(35+boxWidth*3, _view_box.frame.origin.y, boxWidth, boxWidth)];
        ...
        _view_box5 = [[UIView alloc]initWithFrame:CGRectMake(35+boxWidth*4, _view_box.frame.origin.y, boxWidth, boxWidth)];
        ...
        _view_box6 = [[UIView alloc]initWithFrame:CGRectMake(35+boxWidth*5, _view_box.frame.origin.y, boxWidth, boxWidth)];
